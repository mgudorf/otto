"""Science: notebooks under science.root, run on the user-wide Python, one daemon-owned kernel per notebook."""
...
MANIFEST = Manifest(
    ...
    order=4,
    schedules=(Schedule(task="reap", every="5m", resource="science"),),
    agent=Agent(

...
export function Middle({ app, data, mod, fmt }) {
  ...
  return html`<div style=${{ display: 'flex', flexDirection: 'column', gap: 16 }}>
    ...
    <${TextArea} value=${capture.text} placeholder=${{ plan: 'What you are pursuing, in your own words…', person: 'Who, and why they matter…', event: 'What, where, when…' }[capture.kind]}
